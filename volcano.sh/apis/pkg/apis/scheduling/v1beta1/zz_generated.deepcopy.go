...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodAffinitySchedInfo) DeepCopyInto(out *PodAffinitySchedInfo) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodAffinitySchedInfo.
func (in *PodAffinitySchedInfo) DeepCopy() *PodAffinitySchedInfo {
	if in == nil {
		return nil
	}
	out := new(PodAffinitySchedInfo)
	in.DeepCopyInto(out)
	return out
}
