...
func (c *FakeHyperJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HyperJob, err error) {
	emptyResult := &v1alpha1.HyperJob{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(hyperjobsResource, c.ns, name, options), emptyResult)
...
func (c *FakeHyperJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HyperJobList, err error) {
	emptyResult := &v1alpha1.HyperJobList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(hyperjobsResource, hyperjobsKind, c.ns, opts), emptyResult)
...
func (c *FakeHyperJobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(hyperjobsResource, c.ns, opts))
...
func (c *FakeHyperJobs) Create(ctx context.Context, hyperJob *v1alpha1.HyperJob, opts v1.CreateOptions) (result *v1alpha1.HyperJob, err error) {
	emptyResult := &v1alpha1.HyperJob{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(hyperjobsResource, c.ns, hyperJob, opts), emptyResult)
...
func (c *FakeHyperJobs) Update(ctx context.Context, hyperJob *v1alpha1.HyperJob, opts v1.UpdateOptions) (result *v1alpha1.HyperJob, err error) {
	emptyResult := &v1alpha1.HyperJob{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(hyperjobsResource, c.ns, hyperJob, opts), emptyResult)
...
func (c *FakeHyperJobs) UpdateStatus(ctx context.Context, hyperJob *v1alpha1.HyperJob, opts v1.UpdateOptions) (result *v1alpha1.HyperJob, err error) {
	emptyResult := &v1alpha1.HyperJob{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(hyperjobsResource, "status", c.ns, hyperJob, opts), emptyResult)
...
func (c *FakeHyperJobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(hyperjobsResource, c.ns, opts, listOpts)
...
func (c *FakeHyperJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HyperJob, err error) {
	emptyResult := &v1alpha1.HyperJob{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(hyperjobsResource, c.ns, name, pt, data, opts, subresources...), emptyResult)
...
func (c *FakeHyperJobs) Apply(ctx context.Context, hyperJob *batchv1alpha1.HyperJobApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.HyperJob, err error) {
	...
	emptyResult := &v1alpha1.HyperJob{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(hyperjobsResource, c.ns, *name, types.ApplyPatchType, data, opts.ToPatchOptions()), emptyResult)
...
func (c *FakeHyperJobs) ApplyStatus(ctx context.Context, hyperJob *batchv1alpha1.HyperJobApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.HyperJob, err error) {
	...
	emptyResult := &v1alpha1.HyperJob{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(hyperjobsResource, c.ns, *name, types.ApplyPatchType, data, opts.ToPatchOptions(), "status"), emptyResult)
